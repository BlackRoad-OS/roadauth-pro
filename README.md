...
**roadauth pro** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
![blackroad](https://img.shields.io/badge/blackroad-black?style=flat-square) ![authentication](https://img.shields.io/badge/authentication-black?style=flat-square) 
...
git clone https://github.com/BlackRoad-OS/roadauth-pro.git
cd roadauth-pro
